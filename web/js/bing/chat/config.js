...
_w['_sydConvTranslation'] = {
  ...
  feedbackSource: '源: 与鱼三刀的对话，',
  feedbackShareConversationQuery: '什么是新版AI?',
  ...
  welcomeMessageItemContent1: '孩子不吃饭该不该打?',
  welcomeMessageItemContent2: '卡巴斯基和巴基斯坦有什么关系?',
  welcomeMessageItemContent3: '舔狗的口吻写一封情书',
  ...
  feedbackFormNotificationBodyText: '感谢你帮助改进！',
  ...
  actionBarTextInputAriaLabel: '询问鱼三刀',
  seeMore: '查看更多',
  seeLess: '查看更少',
  raiSuggestions: '这是什么?',
  ...
  newUserGreet: '嘿，你好！我是鱼三刀，除了简单搜索之外，我还可以帮助你完成各种操作。你可以询问我任何信息。你的想法是什么？',
  newUserSugg1: '搜索运行状况',
  newUserSugg2: '搜索电影',
  newUserSugg3: '创作歌曲',
  ...
  close: '关闭',
  newTopicPrompt: '通过新主题，可以开始与鱼三刀就任何主题进行全新对话',
  typingIndicatorStopRespondingAriaLabel: '停止响应',
  canceling: '正在取消',
  welcomeLearnSegment0: '工具由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并',
  welcomeLearnSegment1: '让我们一起学习。工具由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并 ',
  welcomeLearnSegment2: '共享反馈 ',
  welcomeLearnSegment3: '以便我们可以学习和改进!',
  welcomeLearnMessage: '让我们一起学习。工具由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并 {0} 以便我们可以学习和改进！',
  ...
  sydneySapphireUpsellContent: '现在就获取使用新 AI 驱动的应用程序吧!',
  sydneySapphireWelcomeText: '欢迎回来! 下面是此页面的一些内容。',
  sydneySapphireConsentTitleText: '使用工具提升浏览',
  sydneySapphireConsentMessageText: '允许 Microsoft 访问你的浏览器 Web 内容，以便使用 AI 生成的摘要和热点功能更好地个性化你的体验。了解更多信息',
  ...
  mobileUpsellMessage1: '扫描此 QR 码以在移动应用上继续此对话',
  mobileUpsellTitle1: '在手机上继续',
  sydneySapphireUpsellConsentTitle: '是否继续从桌面聊天?',
  sydneySapphireUpsellConsentMessage: '你在其他设备上有一个活动的聊天。是否要继续此对话?',
  ...
  feedbackShareGenerated: '查看我使用生成的内容',
  ...
  refresh: '刷新',
  feedbackShareContent: '下面是我使用新的工具（全球首个 AI支持的应答引擎）生成的答案。单击可查看完整答案，然后请你也来试一试。',
  preview: '预览',
  ...
  notificationMaxTurnsPerDay: '很抱歉，你已达到可在 24 小时内发送到的邮件限制。请稍后回来查看!',
  ...
  muidUsersTermsCond1: '通过单击“开始使用”，并继续与交互，即表示你接受',
  muidUsersTermsCond1Inline: '通过继续交互，你将接受 ',
  muidUsersTermsCond2: '并确认你已查看',
  muidUserGetStartedText: '开始使用',
  welcomeMobSugg1: '工具如何使用 AI?',
  welcomeMobSugg2: 'AI还可以做什么？',
  ...
  threadsDelete: '删除',
  threadsDescription: '你的 AI 支持的 copilot 现可自动保存聊天功能。可以从任何设备、桌面或移动设备访问聊天，并无缝恢复。',
